...
```sh
$ npm install sails-generate-florist-subsystem
```

[![NPM](https://nodei.co/npm/sails-generate-florist-subsystem.png?downloads=true&stars=true)](https://nodei.co/npm/sails-generate-florist-subsystem/)
...
[![githalytics.com alpha](https://cruel-carlota.pagodabox.com/8acf2fc2ca0aca8a3018e355ad776ed7 "githalytics.com")](http://githalytics.com/balderdashy/sails-generate-florist-subsystem/FAQ.md)
